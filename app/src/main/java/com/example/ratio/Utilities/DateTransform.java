...
public class DateTransform {
    ...
    private DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm'Z'"); //Parse cloud date format
    private DateFormat simpleFormat = new SimpleDateFormat("yyyy-mm-dd hh:mm:ss");
